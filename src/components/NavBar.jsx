			...
			<nav className="relative w-full flex flex-wrap items-center justify-between py-3 shadow-md shadow-gray-600 bg-white">
				...
				<div className="container-fluid w-full flex flex-wrap items-center justify-between px-6">
					...
					<div className="container-fluid flex flex-row justify-end items-stretch">
						<Link to="/" className={isInHome ? "px-2 hover:text-gray-700 underline underline-offset-8": "px-2 hover:text-gray-700"}>Home</Link>
						<Link to="/recipes" className={isInRecipes ?"px-2 hover:text-gray-700 underline underline-offset-8": "px-2 hover:text-gray-700"}>Recipes</Link>
					</div>
				</div>
			</nav>
		</div>
