 	...
 	return (
 		<div className="h-full">
 			<div className="grid grid-cols-1 gap-8 px-8 my-8">
 				<div className="bg-white border-2 rounded-sm py-8 shadow-lg shadow-gray-600">
 					<div className="px-16">
 						...
 						<div className="px-8 mt-8">
 							...
 							<br/>
							 <Link to="/recipes" className="font-semibold">Go to the Recipes page to check out some recipes.</Link>
